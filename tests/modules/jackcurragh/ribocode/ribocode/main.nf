...
//                 [   file(params.test_data['custom']['homo_sapiens']['chr22_HEK_riboseq_transcriptomic_bam'], checkIfExists: true),
//             ]
//     ]
//     fasta = [
...
//     config = [
//         [id:'test_config'],
//         [file(params.test_data['custom']['ribocode']['chr22_HEK_riboseq_transcriptomic_config'], checkIfExists: true) ]
//     ]
